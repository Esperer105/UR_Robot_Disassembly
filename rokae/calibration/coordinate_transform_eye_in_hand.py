...
config.enable_stream(rs.stream.depth, 1024, 768, rs.format.z16, 30)  # 配置depth流
...
# 读取手眼转换矩阵
M_camera2gripper = np.load('D:\\Realsense\\calibrateHandeye\\M_camera2base_eye_in_hand.npy')
...
final_coordinate1 = np.dot(M_camera2gripper, camera_coordinate2)
# 这一行参数为示教器读数
final_coordinate11 = np.dot(get_matrix_eular_rad_camera(-192.19, -602.30, 470.52, 2.889, 1.119, -0.110, 1),
                            final_coordinate1)
print("final_coordinate_relative_to_base:", final_coordinate11)
