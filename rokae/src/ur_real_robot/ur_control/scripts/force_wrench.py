...
# from sensor_msgs.msg import fake_force_sensor
...
if __name__ == "__main__":
    ...
    wrench_Subscriber = rospy.Subscriber('/wrench', geometry_msgs.msg.WrenchStamped, queue_size=4)


    wrench_pub = rospy.Subscriber('/wrench', Wrench,  queue_size=4)
    ...
    # int_marker = InteractiveMarker()
    # int_marker.header.frame_id = "tool0_controller"
    # int_marker.pose.position = position
    # int_marker.scale = 0.3
    # int_marker.name = "wrench"
    # int_marker.description = "Sim wrench \n Force = vector from UR5 ee to marker \n Torque = angle from initial orientation"
