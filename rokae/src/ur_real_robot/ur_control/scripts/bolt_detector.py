...
class BoltDetector():
    ...
    def transform_roi(self, x1, y1, x2, y2, w, h):
    ...
    # w,h window_size
    def detect(self, img, w=50, h=50, step_size=20, scaleFactor=1.25, threshold=0.995, nms_threshold=0.5, show=False):
        bolts = []
        rectangles = []
        counter = 0
        ret_dict = {}
        ...
        for (x, y, x2, y2, score) in boxes:
            # print(x, y, x2, y2)
            rx1, ry1, rx2, ry2 = self.transform_roi(x, y, x2, y2, w, h)
            # 画圆
