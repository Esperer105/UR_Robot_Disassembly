...
#image_path = "/home/zwang38/sti/rokae_image_9-12/vertical_capture_false_obstacle/"
image_path = "/sti/rokae_image_9-12/vertical_capture_false_obstacle/"
...
# 导入验证集并进行预处理
validate_dataset = datasets.ImageFolder(image_path + "/test", transform=data_transform["test"])
